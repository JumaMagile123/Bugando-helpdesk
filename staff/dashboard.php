...
<div class="container-fluid"><div class="row">
    ...
    <main class="col p-0">
        ...
        <div class="p-4 dashboard-content">
            ...
            <div class="d-flex justify-content-between align-items-end mb-3"><div><p class="text-muted mb-1">Wasilisha tatizo la ICT na fuatilia majibu ya timu ya msaada.</p><h4 class="mb-0">Muhtasari</h4></div></div>
